...
function authAlert(ev, req, extra) {
  ...
  notify.sendTelegram(lines.join('\n'));
}
...
const TAB_ROUTES = new Set(['monitor', 'pm2', 'services', 'postgres', 'postgresql', 'db', 'updates', 'sites', 'modules', 'backups', 'backup', 'ssh', 'terminal', 'events']);
